...
const Qualification = () => {
    ...
    return (
        <main className='w-[90%] m-auto relative flex flex-col justify-center pt-16 items-center min-h-[calc(100vh-56px)]'>
            ...
            <div className={`absolute z-30 w-[80%] md:w-[50%] lg:w-[40%] h-[400px] rounded bg-black top-5 ${AddPrject} AddProjectTransition`}>
                <AddProject/>
            </div>
        </main>
    )
